    ...
    <div class="right">
      ...
      <div class="bottom">
        <div class="area">
          <div class="scrollable-content">
            <playerCard
              v-for="player in selected_players"
              :key="player.id"
              :name="player.name"
...
.area {
  ...
  box-sizing: border-box;
  display: flex; /* Changed from grid to flex for overflow handling */
  overflow: hidden; /* Hide overflow to clip scrollbar */
}

.scrollable-content {
  display: grid; /* Use grid for the inner content */
